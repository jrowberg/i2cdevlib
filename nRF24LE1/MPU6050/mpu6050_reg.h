...
// second though)
unsigned char code dmpMemory[MPU6050_DMP_CODE_SIZE] PROGMEM = {
    // bank 0, 256 bytes
...
unsigned char code dmpConfig[MPU6050_DMP_CONFIG_SIZE] PROGMEM = {
...
unsigned char code dmpUpdates[MPU6050_DMP_UPDATES_SIZE] PROGMEM = {
